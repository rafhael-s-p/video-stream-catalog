package com.studies.catalog.infrastructure.configuration;

import com.studies.catalog.infrastructure.configuration.properties.KafkaProperties;
...
@Profile({"prod", "dev", "sandbox", "e2e-test"})
